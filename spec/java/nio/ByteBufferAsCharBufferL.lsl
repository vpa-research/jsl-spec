...
@public @private type ByteBufferAsCharBufferL
...
: ByteBufferAsCharBufferL
{
    ...
    @private constructor *.`<init>` (@target self: ByteBufferAsCharBufferL, bb: ByteBuffer)
    {
        action TODO();
    }


    @private constructor *.`<init>` (@target self: ByteBufferAsCharBufferL, bb: ByteBuffer, mark: int, pos: int, lim: int, cap: int, addr: long)
    {
        action TODO();
    }
    ...
    @default fun *.codePoints (@target self: ByteBufferAsCharBufferL): IntStream
    {
        action TODO();
    }
