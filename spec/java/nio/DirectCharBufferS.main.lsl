...
: LSLDirectCharBufferS
{
    ...
    // within java.nio.CharBuffer
    @Phantom @final fun *.array (@target self: DirectCharBufferS): array<char>
    {
        action TODO();
    }
    ...
    // within java.nio.CharBuffer
    @Phantom @final fun *.arrayOffset (@target self: DirectCharBufferS): int
    {
        action TODO();
    }
    ...
    @Phantom @final fun *.capacity (@target self: DirectCharBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.CharBuffer
    @Phantom @final fun *.charAt (@target self: DirectCharBufferS, index: int): char
    {
        action TODO();
    }
    ...
    // within java.nio.CharBuffer
    fun *.charRegionOrder (@target self: DirectCharBufferS): ByteOrder
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.clear (@target self: DirectCharBufferS): Buffer
    {
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.flip (@target self: DirectCharBufferS): Buffer
    {
        // #warning: final in CharBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.CharBuffer
    @Phantom @final fun *.hasArray (@target self: DirectCharBufferS): boolean
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.hasRemaining (@target self: DirectCharBufferS): boolean
    {
        action TODO();
    }
    ...
    // within java.nio.CharBuffer
    @Phantom @final fun *.length (@target self: DirectCharBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.limit (@target self: DirectCharBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.limit (@target self: DirectCharBufferS, newLimit: int): Buffer
    {
        // #warning: final in CharBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.mark (@target self: DirectCharBufferS): Buffer
    {
        // #warning: final in CharBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.position (@target self: DirectCharBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.position (@target self: DirectCharBufferS, newPosition: int): Buffer
    {
        // #warning: final in CharBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.CharBuffer
    @Phantom @final fun *.put (@target self: DirectCharBufferS, src: String): CharBuffer
    {
        action TODO();
    }
    ...
    // within java.nio.CharBuffer
    @Phantom @final fun *.put (@target self: DirectCharBufferS, src: array<char>): CharBuffer
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.remaining (@target self: DirectCharBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.reset (@target self: DirectCharBufferS): Buffer
    {
        // #warning: final in CharBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.rewind (@target self: DirectCharBufferS): Buffer
    {
        // #warning: final in CharBuffer, used original method
        action TODO();
    }
