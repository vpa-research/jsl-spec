...
: LSLDirectIntBufferS
{
    ...
    constructor *.`<init>` (@target self: DirectIntBufferS, db: DirectBuffer, mark: int, pos: int, lim: int, cap: int, off: int)
    {
        action TODO();
    }
    ...
    @Phantom @final fun *.array (@target self: DirectIntBufferS): array<int>
    {
        action TODO();
    }
    ...
    // within java.nio.IntBuffer
    @Phantom @final fun *.arrayOffset (@target self: DirectIntBufferS): int
    {
        action TODO();
    }
    ...
    @Phantom @final fun *.capacity (@target self: DirectIntBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.clear (@target self: DirectIntBufferS): Buffer
    {
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.flip (@target self: DirectIntBufferS): Buffer
    {
        // #warning: final in IntBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.IntBuffer
    @Phantom @final fun *.hasArray (@target self: DirectIntBufferS): boolean
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.hasRemaining (@target self: DirectIntBufferS): boolean
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.limit (@target self: DirectIntBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.limit (@target self: DirectIntBufferS, newLimit: int): Buffer
    {
        // #warning: final in IntBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.mark (@target self: DirectIntBufferS): Buffer
    {
        // #warning: final in IntBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.position (@target self: DirectIntBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.position (@target self: DirectIntBufferS, newPosition: int): Buffer
    {
        // #warning: final in IntBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.IntBuffer
    @Phantom @final fun *.put (@target self: DirectIntBufferS, src: array<int>): IntBuffer
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.remaining (@target self: DirectIntBufferS): int
    {
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.reset (@target self: DirectIntBufferS): Buffer
    {
        // #warning: final in IntBuffer, used original method
        action TODO();
    }
    ...
    // within java.nio.Buffer
    @Phantom @final fun *.rewind (@target self: DirectIntBufferS): Buffer
    {
        // #warning: final in IntBuffer, used original method
        action TODO();
    }
